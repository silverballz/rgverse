...
const Notes = () => {
  ...
  const branchList = [
      ...
      handwrittenLinks: [
        {
          ...
          url: "https://drive.google.com/drive/folders/18sRrBh2dmfZaAEj-Rysgp18XEk4kAhg6",
        },
        {
          label: "Handwritten Notes (2022)",
          url: "https://drive.google.com/drive/folders/1FkBUsUKtdytPWEfklanMyY5oF_p74ivc?usp=sharing",
        },
        {
    ...
    },
    {
      ...
      contributors: [
        { name: "@Arik", profileUrl: "/profile/Arik22" },
      ...
      handwrittenLinks: [
        {
          ...
          url: "https://drive.google.com/drive/folders/1vQBS-l5ZurcJFwuk6yoRX_APjOiYjidy",
        },
        {
